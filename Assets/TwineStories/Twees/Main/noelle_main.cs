/*
Generated by UnityTwine on 4/28/2016 11:53:27 PM
...
public class noelle_main: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_4()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineLink(@"%noelle_approval,71,200%Will you marry me?", @"%noelle_approval,71,200%Will you marry me?", @"marriage", null, null);
		yield return new TwineLink(@"%noelle_gift,4,4%I have a gift for you.", @"%noelle_gift,4,4%I have a gift for you.", @"gift", null, null);
		yield return new TwineLink(@"One of the other women in the castle.", @"One of the other women in the castle.", @"women", null, null);
		yield return new TwineLink(@"%noelle_approval,-30,0%How are you enjoying your stay here?", @"%noelle_approval,-30,0%How are you enjoying your stay here?", @"stay1", null, null);
		yield return new TwineLink(@"%noelle_approval,1,30%How are you enjoying your stay here?", @"%noelle_approval,1,30%How are you enjoying your stay here?", @"stay2", null, null);
		yield return new TwineLink(@"%noelle_approval,31,50%How are you enjoying your stay here?", @"%noelle_approval,31,50%How are you enjoying your stay here?", @"stay3", null, null);
		yield return new TwineLink(@"%noelle_approval,50,70%How are you enjoying your stay here?", @"%noelle_approval,50,70%How are you enjoying your stay here?", @"stay4", null, null);
		yield return new TwineLink(@"%convo_points, 1, 2%Let's talk about you.", @"%convo_points, 1, 2%Let's talk about you.", @"you", null, null);
	...
	IEnumerable<TwineOutput> passageExecute_12()
	{
		...
		yield return new TwineText(@"#noelle_approval, +50#");
		yield return new TwineText(@"#noelle_gift, +1#");
		yield return new TwineText(@"%1, <noelle>, <center>, <scared>%");
		yield return new TwineText(@"NOELLE: But this--");
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: --this is--");
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: How on earth did you get my mother's will?");
		yield return new TwineText(@"");
		yield return new TwineText(@"%1, <noelle>, <center>, <frown>%");
		yield return new TwineText(@"NOELLE: You got it from my father, didn't you? Oh, I <i>knew</i> he was hiding it from me!");
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: See, right here, it says that my mother left all her worldly possessions, all her wealth, to me! That I might be free of my father!");
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: I'll ruin him with this, I swear it.");
		yield return new TwineText(@"");
		yield return new TwineText(@"%1, <noelle>, <center>, <smile>%");
		yield return new TwineText(@"NOELLE: ...Thank you. You've helped me in a way I never expected anyone to want to, much less be capable of.");
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: You may be the finest man I've ever met.");
		yield return new TwineText(@"");
		yield return new TwineText(@"%1, <noelle>, <center>, <neutral>%");
		yield return new TwineText(@"NOELLE: Now, please excuse me for a moment. I need to read over this thoroughly.");	
	}
	...
	void passageInit_13()
	{
		this.Passages["women"] = new TwinePassage("women", new string[]{  }, passageExecute_13);
	}
	...
	void passageInit_14()
	{
		this.Passages["p1"] = new TwinePassage("p1", new string[]{  }, passageExecute_14);
	}
	...
	void passageInit_15()
	{
		this.Passages["p2"] = new TwinePassage("p2", new string[]{  }, passageExecute_15);
	}
	...
	void passageInit_16()
	{
		this.Passages["l1"] = new TwinePassage("l1", new string[]{  }, passageExecute_16);
	}
	...
	void passageInit_17()
	{
		this.Passages["l2"] = new TwinePassage("l2", new string[]{  }, passageExecute_17);
	}
	...
	void passageInit_18()
	{
		this.Passages["men"] = new TwinePassage("men", new string[]{  }, passageExecute_18);
	}

	IEnumerable<TwineOutput> passageExecute_18()
	{
		yield return new TwineText(@"#convo_points, -1#");
		yield return new TwineText(@"#noelle_convo, +1#");
		yield return new TwineText(@"%1, <noelle>, <center>, <neutral>%");
	...
	// .............
	// #19: I suppose it must be easier that way.

	void passageInit_19()
	{
		this.Passages["I suppose it must be easier that way."] = new TwinePassage("I suppose it must be easier that way.", new string[]{  }, passageExecute_19);
	}

	IEnumerable<TwineOutput> passageExecute_19()
	{
		yield return new TwineText(@"#noelle_approval, -5#");
		yield return new TwineText(@"$NoelleAngry$");
		yield return new TwineText(@"%1, <noelle>, <center>, <frown>%");
	...
	// .............
	// #20: That doesn't mean it isn't awful.

	void passageInit_20()
	{
		this.Passages["That doesn't mean it isn't awful."] = new TwinePassage("That doesn't mean it isn't awful.", new string[]{  }, passageExecute_20);
	}
	...
	// .............
	// #21: At least you have your father.

	void passageInit_21()
	{
		this.Passages["At least you have your father."] = new TwinePassage("At least you have your father.", new string[]{  }, passageExecute_21);
	}
	...
	void passageInit_22()
	{
		this.Passages["family"] = new TwinePassage("family", new string[]{  }, passageExecute_22);
	}
	...
	void passageInit_23()
	{
		this.Passages["you"] = new TwinePassage("you", new string[]{  }, passageExecute_23);
	}
	...
	// .............
	// #24: You don't think very highly of men in general, then.

	void passageInit_24()
	{
		this.Passages["You don't think very highly of men in general, then."] = new TwinePassage("You don't think very highly of men in general, then.", new string[]{  }, passageExecute_24);
	}
	...
	// .............
	// #25: What kind of flaws?

	void passageInit_25()
	{
		this.Passages["What kind of flaws?"] = new TwinePassage("What kind of flaws?", new string[]{  }, passageExecute_25);
	}
	...
	// .............
	// #26: Do human flaws really merit such disdain?

	void passageInit_26()
	{
		this.Passages["Do human flaws really merit such disdain?"] = new TwinePassage("Do human flaws really merit such disdain?", new string[]{  }, passageExecute_26);
	}
	...
	// .............
	// #27: I'd like to know more about this, actually.

	void passageInit_27()
	{
		this.Passages["I'd like to know more about this, actually."] = new TwinePassage("I'd like to know more about this, actually.", new string[]{  }, passageExecute_27);
	}
	...
	void passageInit_28()
	{
		this.Passages["from"] = new TwinePassage("from", new string[]{  }, passageExecute_28);
	}
	...
	void passageInit_29()
	{
		this.Passages["marriage"] = new TwinePassage("marriage", new string[]{  }, passageExecute_29);
	}

	IEnumerable<TwineOutput> passageExecute_29()
	{
		yield return new TwineText(@"%1, <noelle>, <center>, <blush>%");
		yield return new TwineText(@"NOELLE: I never, ever thought I would say yes to a marriage proposal.");
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: But somehow, you managed to make me love you, in a way I never thought I could love a man.");
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: Yes, I will gladly marry you!");
		yield return new TwineText(@"");
		yield return new TwineText(@"&Noelle&");	
	}
    
	// .............
	// #30: I rather like having you at my mercy.

	void passageInit_30()
	{
		this.Passages["I rather like having you at my mercy."] = new TwinePassage("I rather like having you at my mercy.", new string[]{  }, passageExecute_30);
	}
	...
	// .............
	// #31: I've never thought of it that way before.

	void passageInit_31()
	{
		this.Passages["I've never thought of it that way before."] = new TwinePassage("I've never thought of it that way before.", new string[]{  }, passageExecute_31);
	}
	...
	// .............
	// #32: I'm certainly not doing a very good job of disproving your point, am I?

	void passageInit_32()
	{
		this.Passages["I'm certainly not doing a very good job of disproving your point, am I?"] = new TwinePassage("I'm certainly not doing a very good job of disproving your point, am I?", new string[]{  }, passageExecute_32);
	}
	...
	// .............
	// #33: Shouldn't you be proud to have such a successful father?

	void passageInit_33()
	{
		this.Passages["Shouldn't you be proud to have such a successful father?"] = new TwinePassage("Shouldn't you be proud to have such a successful father?", new string[]{  }, passageExecute_33);
	}
	...
	// .............
	// #34: But not a very good man.

	void passageInit_34()
	{
		this.Passages["But not a very good man."] = new TwinePassage("But not a very good man.", new string[]{  }, passageExecute_34);
	}
	...
	// .............
	// #35: At least you have a father.

	void passageInit_35()
	{
		this.Passages["At least you have a father."] = new TwinePassage("At least you have a father.", new string[]{  }, passageExecute_35);
	}
	...
	// .............
	// #36: So men are sub-human, in your eyes.

	void passageInit_36()
	{
		this.Passages["So men are sub-human, in your eyes."] = new TwinePassage("So men are sub-human, in your eyes.", new string[]{  }, passageExecute_36);
	}
	...
	// .............
	// #37: Are women so much better than men?

	void passageInit_37()
	{
		this.Passages["Are women so much better than men?"] = new TwinePassage("Are women so much better than men?", new string[]{  }, passageExecute_37);
	}
	...
	// .............
	// #38: And what about me? Am I a man in your eyes?

	void passageInit_38()
	{
		this.Passages["And what about me? Am I a man in your eyes?"] = new TwinePassage("And what about me? Am I a man in your eyes?", new string[]{  }, passageExecute_38);
	}
	...
	// .............
	// #39: Are you really happy with the way your father's raised you?

	void passageInit_39()
	{
		this.Passages["Are you really happy with the way your father's raised you?"] = new TwinePassage("Are you really happy with the way your father's raised you?", new string[]{  }, passageExecute_39);
	}
	...
	// .............
	// #40: How did your mother die?

	void passageInit_40()
	{
		this.Passages["How did your mother die?"] = new TwinePassage("How did your mother die?", new string[]{  }, passageExecute_40);
	}
	...
	// .............
	// #41: I know what it's like to lose your parents.

	void passageInit_41()
	{
		this.Passages["I know what it's like to lose your parents."] = new TwinePassage("I know what it's like to lose your parents.", new string[]{  }, passageExecute_41);
	}
	...
	IEnumerable<TwineOutput> passageExecute_41()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineLink(@"Very well. Let's talk about something else.]]
		[[Actually, I have to go.", @"Very well. Let's talk about something else.]]
		[[Actually, I have to go.", @"leave", null, null);	
	}
    
	// .............
	// #42: Have you ever wanted to live anywhere else?

	void passageInit_42()
	{
		this.Passages["Have you ever wanted to live anywhere else?"] = new TwinePassage("Have you ever wanted to live anywhere else?", new string[]{  }, passageExecute_42);
	}
	...
	IEnumerable<TwineOutput> passageExecute_42()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineLink(@"'Very little' is still something. What do you want?", @"'Very little' is still something. What do you want?", @"'Very little' is still something. What do you want?", null, null);
	...
	// .............
	// #43: Have you always lived there?

	void passageInit_43()
	{
		this.Passages["Have you always lived there?"] = new TwinePassage("Have you always lived there?", new string[]{  }, passageExecute_43);
	}
	...
	// .............
	// #44: Why would you want to get lost?

	void passageInit_44()
	{
		this.Passages["Why would you want to get lost?"] = new TwinePassage("Why would you want to get lost?", new string[]{  }, passageExecute_44);
	}
	...
	IEnumerable<TwineOutput> passageExecute_44()
	{
		...
		yield return new TwineLink(@"Why be one of many when you could stand out?", @"Why be one of many when you could stand out?", @"Why be one of many when you could stand out?", null, null);
	...
	// .............
	// #45: I'll be leaving, then.

	void passageInit_45()
	{
		this.Passages["I'll be leaving, then."] = new TwinePassage("I'll be leaving, then.", new string[]{  }, passageExecute_45);
	}
	...
	void passageInit_46()
	{
		this.Passages["leave"] = new TwinePassage("leave", new string[]{  }, passageExecute_46);
	}
	...
	// .............
	// #47: I have the same dream. Every day.

	void passageInit_47()
	{
		this.Passages["I have the same dream. Every day."] = new TwinePassage("I have the same dream. Every day.", new string[]{  }, passageExecute_47);
	}
	...
	// .............
	// #48: It must be nice, to live so comfortably.

	void passageInit_48()
	{
		this.Passages["It must be nice, to live so comfortably."] = new TwinePassage("It must be nice, to live so comfortably.", new string[]{  }, passageExecute_48);
	}
	...
	// .............
	// #49: 'Very little' is still something. What do you want?

	void passageInit_49()
	{
		this.Passages["'Very little' is still something. What do you want?"] = new TwinePassage("'Very little' is still something. What do you want?", new string[]{  }, passageExecute_49);
	}
	...
	// .............
	// #50: That does sound nice.

	void passageInit_50()
	{
		this.Passages["That does sound nice."] = new TwinePassage("That does sound nice.", new string[]{  }, passageExecute_50);
	}
	...
	// .............
	// #51: Why be one of many when you could stand out?

	void passageInit_51()
	{
		this.Passages["Why be one of many when you could stand out?"] = new TwinePassage("Why be one of many when you could stand out?", new string[]{  }, passageExecute_51);
	}
	...
	// .............
	// #52: I wouldn't know what that's like.

	void passageInit_52()
	{
		this.Passages["I wouldn't know what that's like."] = new TwinePassage("I wouldn't know what that's like.", new string[]{  }, passageExecute_52);
	}
	...
	// .............
	// #53: It's certainly something to think about.

	void passageInit_53()
	{
		this.Passages["It's certainly something to think about."] = new TwinePassage("It's certainly something to think about.", new string[]{  }, passageExecute_53);
	}
	...
	// .............
	// #54: I'm not sure I do.

	void passageInit_54()
	{
		this.Passages["I'm not sure I do."] = new TwinePassage("I'm not sure I do.", new string[]{  }, passageExecute_54);
	}
	...
	// .............
	// #55: I take it he's not very nice outside his office.

	void passageInit_55()
	{
		this.Passages["I take it he's not very nice outside his office."] = new TwinePassage("I take it he's not very nice outside his office.", new string[]{  }, passageExecute_55);
	}
	...
	// .............
	// #56: His personal life doesn't invalidate his professional accomplishments.

	void passageInit_56()
	{
		this.Passages["His personal life doesn't invalidate his professional accomplishments."] = new TwinePassage("His personal life doesn't invalidate his professional accomplishments.", new string[]{  }, passageExecute_56);
	}
	...
	// .............
	// #57: So the offense in unintentional, then. That makes it all better.

	void passageInit_57()
	{
		this.Passages["So the offense in unintentional, then. That makes it all better."] = new TwinePassage("So the offense in unintentional, then. That makes it all better.", new string[]{  }, passageExecute_57);
	}
	...
	// .............
	// #58: You're getting awfully defensive.

	void passageInit_58()
	{
		this.Passages["You're getting awfully defensive."] = new TwinePassage("You're getting awfully defensive.", new string[]{  }, passageExecute_58);
	}
	...
	// .............
	// #59: I think I do, actually.

	void passageInit_59()
	{
		this.Passages["I think I do, actually."] = new TwinePassage("I think I do, actually.", new string[]{  }, passageExecute_59);
	}
	...
	void passageInit_60()
	{
		this.Passages["You're probably right about that."] = new TwinePassage("You're probably right about that.", new string[]{  }, passageExecute_60);
	}
	...
	// .............
	// #61: Not many people share your opinion.

	void passageInit_61()
	{
		this.Passages["Not many people share your opinion."] = new TwinePassage("Not many people share your opinion.", new string[]{  }, passageExecute_61);
	}
	...
	// .............
	// #62: You seem unusually convinced there's a man under all of this.

	void passageInit_62()
	{
		this.Passages["You seem unusually convinced there's a man under all of this."] = new TwinePassage("You seem unusually convinced there's a man under all of this.", new string[]{  }, passageExecute_62);
	}
	...
	void passageInit_63()
	{
		this.Passages["It's alright."] = new TwinePassage("It's alright.", new string[]{  }, passageExecute_63);
	}
	...
	// .............
	// #64: It must be nice to forget how hideous I am.

	void passageInit_64()
	{
		this.Passages["It must be nice to forget how hideous I am."] = new TwinePassage("It must be nice to forget how hideous I am.", new string[]{  }, passageExecute_64);
	}
	...
	// .............
	// #65: I don't have much experience with women, myself.

	void passageInit_65()
	{
		this.Passages["I don't have much experience with women, myself."] = new TwinePassage("I don't have much experience with women, myself.", new string[]{  }, passageExecute_65);
	}
	...
	// .............
	// #66: Maybe you just haven't met the right men.

	void passageInit_66()
	{
		this.Passages["Maybe you just haven't met the right men."] = new TwinePassage("Maybe you just haven't met the right men.", new string[]{  }, passageExecute_66);
	}
	...
	// .............
	// #67: Actually, I have to leave.

	void passageInit_67()
	{
		this.Passages["Actually, I have to leave."] = new TwinePassage("Actually, I have to leave.", new string[]{  }, passageExecute_67);
	}
	...
	void passageInit_68()
	{
		this.Passages["You have a point."] = new TwinePassage("You have a point.", new string[]{  }, passageExecute_68);
	}
	...
	// .............
	// #69: I don't think it's the same at all. You aren't a monster.

	void passageInit_69()
	{
		this.Passages["I don't think it's the same at all. You aren't a monster."] = new TwinePassage("I don't think it's the same at all. You aren't a monster.", new string[]{  }, passageExecute_69);
	}
	...
	// .............
	// #70: No, please, tell me more.

	void passageInit_70()
	{
		this.Passages["No, please, tell me more."] = new TwinePassage("No, please, tell me more.", new string[]{  }, passageExecute_70);
	}
	...
	// .............
	// #71: Very well. Let's talk about something else.

	void passageInit_71()
	{
		this.Passages["Very well. Let's talk about something else."] = new TwinePassage("Very well. Let's talk about something else.", new string[]{  }, passageExecute_71);
	}
	...
	// .............
	// #72: I know that feeling very well myself.

	void passageInit_72()
	{
		this.Passages["I know that feeling very well myself."] = new TwinePassage("I know that feeling very well myself.", new string[]{  }, passageExecute_72);
	}
	...
	IEnumerable<TwineOutput> passageExecute_93()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"NOELLE: <color=""white"">But without the will, I'll never know for sure.</color>");
		yield return new TwineText(@"");
	...
	IEnumerable<TwineOutput> passageExecute_98()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"$NoelleBlush$");
		yield return new TwineText(@"%1, <noelle>, <center>, <blush>%");
	...
	IEnumerable<TwineOutput> passageExecute_106()
	{
		...
		yield return new TwineLink(@"Do you think I could be someone else in the New World?]]
		[[Very well. Let's talk about something else.]]
		[[Actually, I have to go.", @"Do you think I could be someone else in the New World?]]
		[[Very well. Let's talk about something else.]]
		[[Actually, I have to go.", @"leave", null, null);	
	}
