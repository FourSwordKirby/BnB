/*
Generated by UnityTwine on 4/28/2016 11:35:06 PM
...
public class hen_main: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_1()
	{
		...
		yield return new TwineLink(@"%hen_gift,4,4%I have a gift for you.", @"%hen_gift,4,4%I have a gift for you.", @"gift", null, null);
		yield return new TwineLink(@"What do you think of the other women in the castle?", @"What do you think of the other women in the castle?", @"women", null, null);
