/*
Generated by UnityTwine on 4/10/2016 12:46:30 PM
...
public class tutorial_end: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"BEAUREGARD: Please, feel free to go wherever you like. The castle is your home now, at least for this week.");
		yield return new TwineText(@"");
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: Light conversation is all well and good, but should you talk to your suitors about something more personal, you may lose track of time. Two deeper conversations, and poof! You'll find that it's dinnertime already.");
		yield return new TwineText(@"");
		yield return new TwineText(@"%1, <beau>, <center>, <smile>%");
