...
public class patrice_gift: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"BEAUREGARD: Oh, sire! One more thing, before you go. I have the item you requested I retrieve! I'm sure Patrice will be very pleased to recieve it.");	
	}
