/*
Generated by UnityTwine on 4/3/2016 8:17:22 PM
...
public class tutorial_b: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_7()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: I'll be waiting for you out in the great hall. Good luck, sire!");	
	}
	...
	IEnumerable<TwineOutput> passageExecute_8()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: I'll be waiting for you out in the great hall.");	
	}
	...
	IEnumerable<TwineOutput> passageExecute_9()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: Come on, then. I'll meet you out in the great hall.");	
	}
