...
public class lucille_gone: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"BEAUREGARD: Lady Lucille is nowhere to be found. It seems she's left the castle--and she's taken a good portion of the wine cellar with her.");	
	}
