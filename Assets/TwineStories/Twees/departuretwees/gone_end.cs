...
public class gone_end: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"BEAUREGARD: Please, sire, try not to scare off the rest of our guests. You'll never be able to break the curse if they all leave.");	
	}
