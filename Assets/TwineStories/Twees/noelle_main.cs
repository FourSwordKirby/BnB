...
public class noelle_main: TwineStory
{
	...
	// .............
	// #22: Let's talk about you.

	void passageInit_22()
	{
		this.Passages["Let's talk about you."] = new TwinePassage("Let's talk about you.", new string[]{  }, passageExecute_22);
	}
	...
	IEnumerable<TwineOutput> passageExecute_22()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineLink(@"%noelle_convo, 0, 1%Where are you from?", @"%noelle_convo, 0, 1%Where are you from?", @"from", null, null);
		yield return new TwineLink(@"%noelle_convo, 0, 1%What is your family like?", @"%noelle_convo, 0, 1%What is your family like?", @"family", null, null);
		yield return new TwineLink(@"%noelle_convo, 2, 3%If you could go anywhere in the world, where would you go?", @"%noelle_convo, 2, 3%If you could go anywhere in the world, where would you go?", @"world", null, null);
		yield return new TwineLink(@"%noelle_convo, 2, 3%You don't seem to think very highly of your father.", @"%noelle_convo, 2, 3%You don't seem to think very highly of your father.", @"men", null, null);
	...
	// .............
	// #43: I'll be leaving, then.

	void passageInit_43()
	{
		this.Passages["I'll be leaving, then."] = new TwinePassage("I'll be leaving, then.", new string[]{  }, passageExecute_43);
	}
	...
	// .............
	// #44: Actually, I have to go.

	void passageInit_44()
	{
		this.Passages["Actually, I have to go."] = new TwinePassage("Actually, I have to go.", new string[]{  }, passageExecute_44);
	}
	...
	// .............
	// #45: I have the same dream. Every day.

	void passageInit_45()
	{
		this.Passages["I have the same dream. Every day."] = new TwinePassage("I have the same dream. Every day.", new string[]{  }, passageExecute_45);
	}
	...
	// .............
	// #46: It must be nice, to live so comfortably.

	void passageInit_46()
	{
		this.Passages["It must be nice, to live so comfortably."] = new TwinePassage("It must be nice, to live so comfortably.", new string[]{  }, passageExecute_46);
	}
	...
	// .............
	// #47: 'Very little' is still something. What is it you want?

	void passageInit_47()
	{
		this.Passages["'Very little' is still something. What is it you want?"] = new TwinePassage("'Very little' is still something. What is it you want?", new string[]{  }, passageExecute_47);
	}
	...
	// .............
	// #48: That does sound nice.

	void passageInit_48()
	{
		this.Passages["That does sound nice."] = new TwinePassage("That does sound nice.", new string[]{  }, passageExecute_48);
	}
	...
	// .............
	// #49: Why would you want to be one of many when you could stand out?

	void passageInit_49()
	{
		this.Passages["Why would you want to be one of many when you could stand out?"] = new TwinePassage("Why would you want to be one of many when you could stand out?", new string[]{  }, passageExecute_49);
	}
	...
	// .............
	// #50: I wouldn't know what that's like.

	void passageInit_50()
	{
		this.Passages["I wouldn't know what that's like."] = new TwinePassage("I wouldn't know what that's like.", new string[]{  }, passageExecute_50);
	}
	...
	// .............
	// #51: It's certainly something to think about.

	void passageInit_51()
	{
		this.Passages["It's certainly something to think about."] = new TwinePassage("It's certainly something to think about.", new string[]{  }, passageExecute_51);
	}
	...
	// .............
	// #52: I'm not sure I do.

	void passageInit_52()
	{
		this.Passages["I'm not sure I do."] = new TwinePassage("I'm not sure I do.", new string[]{  }, passageExecute_52);
	}
	...
	// .............
	// #53: I take it he's not very nice outside his office.

	void passageInit_53()
	{
		this.Passages["I take it he's not very nice outside his office."] = new TwinePassage("I take it he's not very nice outside his office.", new string[]{  }, passageExecute_53);
	}
	...
	// .............
	// #54: His personal life doesn't invalidate his professional accomplishments.

	void passageInit_54()
	{
		this.Passages["His personal life doesn't invalidate his professional accomplishments."] = new TwinePassage("His personal life doesn't invalidate his professional accomplishments.", new string[]{  }, passageExecute_54);
	}
	...
	// .............
	// #55: So the offense in unintentional, then. That makes it all better.

	void passageInit_55()
	{
		this.Passages["So the offense in unintentional, then. That makes it all better."] = new TwinePassage("So the offense in unintentional, then. That makes it all better.", new string[]{  }, passageExecute_55);
	}
	...
	// .............
	// #56: You're getting awfully defensive.

	void passageInit_56()
	{
		this.Passages["You're getting awfully defensive."] = new TwinePassage("You're getting awfully defensive.", new string[]{  }, passageExecute_56);
	}
	...
	// .............
	// #57: I think I do, actually.

	void passageInit_57()
	{
		this.Passages["I think I do, actually."] = new TwinePassage("I think I do, actually.", new string[]{  }, passageExecute_57);
	}
	...
	// .............
	// #58: You're probably right about that.

	void passageInit_58()
	{
		this.Passages["You're probably right about that."] = new TwinePassage("You're probably right about that.", new string[]{  }, passageExecute_58);
	}
	...
	// .............
	// #59: Not many people share your opinion.

	void passageInit_59()
	{
		this.Passages["Not many people share your opinion."] = new TwinePassage("Not many people share your opinion.", new string[]{  }, passageExecute_59);
	}
	...
	// .............
	// #60: You seem unusually convinced there's a man under all of this.

	void passageInit_60()
	{
		this.Passages["You seem unusually convinced there's a man under all of this."] = new TwinePassage("You seem unusually convinced there's a man under all of this.", new string[]{  }, passageExecute_60);
	}
	...
	void passageInit_61()
	{
		this.Passages["It's alright."] = new TwinePassage("It's alright.", new string[]{  }, passageExecute_61);
	}
	...
	// .............
	// #62: It must be nice to forget how hideous I am.

	void passageInit_62()
	{
		this.Passages["It must be nice to forget how hideous I am."] = new TwinePassage("It must be nice to forget how hideous I am.", new string[]{  }, passageExecute_62);
	}
	...
	// .............
	// #63: I don't have much experience with women, myself.

	void passageInit_63()
	{
		this.Passages["I don't have much experience with women, myself."] = new TwinePassage("I don't have much experience with women, myself.", new string[]{  }, passageExecute_63);
	}
	...
	// .............
	// #64: Maybe you just haven't met the right men.

	void passageInit_64()
	{
		this.Passages["Maybe you just haven't met the right men."] = new TwinePassage("Maybe you just haven't met the right men.", new string[]{  }, passageExecute_64);
	}
	...
	// .............
	// #65: Actually, I have to leave.

	void passageInit_65()
	{
		this.Passages["Actually, I have to leave."] = new TwinePassage("Actually, I have to leave.", new string[]{  }, passageExecute_65);
	}
	...
	void passageInit_66()
	{
		this.Passages["You have a point."] = new TwinePassage("You have a point.", new string[]{  }, passageExecute_66);
	}
	...
	// .............
	// #67: I don't think it's the same at all. You aren't a monster.

	void passageInit_67()
	{
		this.Passages["I don't think it's the same at all. You aren't a monster."] = new TwinePassage("I don't think it's the same at all. You aren't a monster.", new string[]{  }, passageExecute_67);
	}
	...
	// .............
	// #68: No, please, tell me more.

	void passageInit_68()
	{
		this.Passages["No, please, tell me more."] = new TwinePassage("No, please, tell me more.", new string[]{  }, passageExecute_68);
	}
	...
	// .............
	// #69: Very well. Let's talk about something else.

	void passageInit_69()
	{
		this.Passages["Very well. Let's talk about something else."] = new TwinePassage("Very well. Let's talk about something else.", new string[]{  }, passageExecute_69);
	}
	...
	// .............
	// #70: I know that feeling very well myself.

	void passageInit_70()
	{
		this.Passages["I know that feeling very well myself."] = new TwinePassage("I know that feeling very well myself.", new string[]{  }, passageExecute_70);
	}
	...
	void passageInit_71()
	{
		this.Passages["GIFT"] = new TwinePassage("GIFT", new string[]{  }, passageExecute_71);
	}
	...
	void passageInit_72()
	{
		this.Passages["father"] = new TwinePassage("father", new string[]{  }, passageExecute_72);
	}
	...
	void passageInit_73()
	{
		this.Passages["unhappy"] = new TwinePassage("unhappy", new string[]{  }, passageExecute_73);
	}
	...
	void passageInit_74()
	{
		this.Passages["world"] = new TwinePassage("world", new string[]{  }, passageExecute_74);
	}
	...
	// .............
	// #75: Perhaps he's only acting out of fatherly concern.

	void passageInit_75()
	{
		this.Passages["Perhaps he's only acting out of fatherly concern."] = new TwinePassage("Perhaps he's only acting out of fatherly concern.", new string[]{  }, passageExecute_75);
	}
	...
	// .............
	// #76: Was it different when your mother was alive?

	void passageInit_76()
	{
		this.Passages["Was it different when your mother was alive?"] = new TwinePassage("Was it different when your mother was alive?", new string[]{  }, passageExecute_76);
	}
	...
	// .............
	// #77: And yet you've never been married? I find that hard to believe.

	void passageInit_77()
	{
		this.Passages["And yet you've never been married? I find that hard to believe."] = new TwinePassage("And yet you've never been married? I find that hard to believe.", new string[]{  }, passageExecute_77);
	}
	...
	void passageInit_78()
	{
		this.Passages["It's hard not to."] = new TwinePassage("It's hard not to.", new string[]{  }, passageExecute_78);
	}
	...
	// .............
	// #79: The other women in the castle have noticed it as well.

	void passageInit_79()
	{
		this.Passages["The other women in the castle have noticed it as well."] = new TwinePassage("The other women in the castle have noticed it as well.", new string[]{  }, passageExecute_79);
	}
	...
	// .............
	// #80: If you don't want to talk about it, you should just say so.

	void passageInit_80()
	{
		this.Passages["If you don't want to talk about it, you should just say so."] = new TwinePassage("If you don't want to talk about it, you should just say so.", new string[]{  }, passageExecute_80);
	}
	...
	void passageInit_81()
	{
		this.Passages["New World"] = new TwinePassage("New World", new string[]{  }, passageExecute_81);
	}
	...
	// .............
	// #82: Are you not happy with the person you are now?

	void passageInit_82()
	{
		this.Passages["Are you not happy with the person you are now?"] = new TwinePassage("Are you not happy with the person you are now?", new string[]{  }, passageExecute_82);
	}
	...
	// .............
	// #83: That sounds...sinister.

	void passageInit_83()
	{
		this.Passages["That sounds...sinister."] = new TwinePassage("That sounds...sinister.", new string[]{  }, passageExecute_83);
	}
	...
	// .............
	// #84: Have you never thought to marry for love?

	void passageInit_84()
	{
		this.Passages["Have you never thought to marry for love?"] = new TwinePassage("Have you never thought to marry for love?", new string[]{  }, passageExecute_84);
	}
	...
	// .............
	// #85: Surely none of them were that bad.

	void passageInit_85()
	{
		this.Passages["Surely none of them were that bad."] = new TwinePassage("Surely none of them were that bad.", new string[]{  }, passageExecute_85);
	}
	...
	// .............
	// #86: I just want to know if I can help.

	void passageInit_86()
	{
		this.Passages["I just want to know if I can help."] = new TwinePassage("I just want to know if I can help.", new string[]{  }, passageExecute_86);
	}
	...
	// .............
	// #87: Fine. If you want to keep deflecting, we don't have to talk about it.

	void passageInit_87()
	{
		this.Passages["Fine. If you want to keep deflecting, we don't have to talk about it."] = new TwinePassage("Fine. If you want to keep deflecting, we don't have to talk about it.", new string[]{  }, passageExecute_87);
	}
	...
	// .............
	// #88: Wouldn't it be better to not be so naive about new things?

	void passageInit_88()
	{
		this.Passages["Wouldn't it be better to not be so naive about new things?"] = new TwinePassage("Wouldn't it be better to not be so naive about new things?", new string[]{  }, passageExecute_88);
	}
	...
	// .............
	// #89: You certainly aren't thinking about it realistically, but that's not bad.

	void passageInit_89()
	{
		this.Passages["You certainly aren't thinking about it realistically, but that's not bad."] = new TwinePassage("You certainly aren't thinking about it realistically, but that's not bad.", new string[]{  }, passageExecute_89);
	}
	...
	// .............
	// #90: I think that sounds very exciting, too.

	void passageInit_90()
	{
		this.Passages["I think that sounds very exciting, too."] = new TwinePassage("I think that sounds very exciting, too.", new string[]{  }, passageExecute_90);
	}
	...
	// .............
	// #91: No, no, I want to hear more.

	void passageInit_91()
	{
		this.Passages["No, no, I want to hear more."] = new TwinePassage("No, no, I want to hear more.", new string[]{  }, passageExecute_91);
	}
	...
	// .............
	// #92: You don't sound as if you believe that.

	void passageInit_92()
	{
		this.Passages["You don't sound as if you believe that."] = new TwinePassage("You don't sound as if you believe that.", new string[]{  }, passageExecute_92);
	}
	...
	// .............
	// #93: Do you think your father hid it?

	void passageInit_93()
	{
		this.Passages["Do you think your father hid it?"] = new TwinePassage("Do you think your father hid it?", new string[]{  }, passageExecute_93);
	}
	...
	// .............
	// #94: What was in the will?

	void passageInit_94()
	{
		this.Passages["What was in the will?"] = new TwinePassage("What was in the will?", new string[]{  }, passageExecute_94);
	}
	...
	// .............
	// #95: You can tell me anything.

	void passageInit_95()
	{
		this.Passages["You can tell me anything."] = new TwinePassage("You can tell me anything.", new string[]{  }, passageExecute_95);
	}
	...
	// .............
	// #96: We don't have to talk about it if you don't want to.

	void passageInit_96()
	{
		this.Passages["We don't have to talk about it if you don't want to."] = new TwinePassage("We don't have to talk about it if you don't want to.", new string[]{  }, passageExecute_96);
	}
	...
	void passageInit_97()
	{
		this.Passages["New World2"] = new TwinePassage("New World2", new string[]{  }, passageExecute_97);
	}
	...
	// .............
	// #98: Being a wealthy merchant's daughter is stifling?

	void passageInit_98()
	{
		this.Passages["Being a wealthy merchant's daughter is stifling?"] = new TwinePassage("Being a wealthy merchant's daughter is stifling?", new string[]{  }, passageExecute_98);
	}
	...
	void passageInit_99()
	{
		this.Passages["I feel the same way."] = new TwinePassage("I feel the same way.", new string[]{  }, passageExecute_99);
	}
	...
	{
		this.Passages["I'm sorry to hear that."] = new TwinePassage("I'm sorry to hear that.", new string[]{  }, passageExecute_100);
	}
	...
	// .............
	// #101: If you marry me, you won't have to worry about money.

	void passageInit_101()
	{
		this.Passages["If you marry me, you won't have to worry about money."] = new TwinePassage("If you marry me, you won't have to worry about money.", new string[]{  }, passageExecute_101);
	}
	...
	// .............
	// #102: Maybe I can get it for you.

	void passageInit_102()
	{
		this.Passages["Maybe I can get it for you."] = new TwinePassage("Maybe I can get it for you.", new string[]{  }, passageExecute_102);
	}
	...
	// .............
	// #103: Someone handsome.

	void passageInit_103()
	{
		this.Passages["Someone handsome."] = new TwinePassage("Someone handsome.", new string[]{  }, passageExecute_103);
	}
	...
	// .............
	// #104: Do you think I could be someone else in the New World?

	void passageInit_104()
	{
		this.Passages["Do you think I could be someone else in the New World?"] = new TwinePassage("Do you think I could be someone else in the New World?", new string[]{  }, passageExecute_104);
	}
	...
	// .............
	// #105: Don't stop on my account.

	void passageInit_105()
	{
		this.Passages["Don't stop on my account."] = new TwinePassage("Don't stop on my account.", new string[]{  }, passageExecute_105);
	}
	...
	// .............
	// #106: Thank you for telling me.

	void passageInit_106()
	{
		this.Passages["Thank you for telling me."] = new TwinePassage("Thank you for telling me.", new string[]{  }, passageExecute_106);
	}
	...
	// .............
	// #107: Does your father not let you make your own decisions?

	void passageInit_107()
	{
		this.Passages["Does your father not let you make your own decisions?"] = new TwinePassage("Does your father not let you make your own decisions?", new string[]{  }, passageExecute_107);
	}
	...
	// .............
	// #108: You'd be surprised what I know.

	void passageInit_108()
	{
		this.Passages["You'd be surprised what I know."] = new TwinePassage("You'd be surprised what I know.", new string[]{  }, passageExecute_108);
	}
	...
	{
		this.Passages["I wouldn't know."] = new TwinePassage("I wouldn't know.", new string[]{  }, passageExecute_109);
	}
	...
	// .............
	// #110: Being a prince isn't the problem.

	void passageInit_110()
	{
		this.Passages["Being a prince isn't the problem."] = new TwinePassage("Being a prince isn't the problem.", new string[]{  }, passageExecute_110);
	}
	...
	// .............
	// #111: Someone powerful.

	void passageInit_111()
	{
		this.Passages["Someone powerful."] = new TwinePassage("Someone powerful.", new string[]{  }, passageExecute_111);
	}
	...
	// .............
	// #112: Someone ordinary.

	void passageInit_112()
	{
		this.Passages["Someone ordinary."] = new TwinePassage("Someone ordinary.", new string[]{  }, passageExecute_112);
	}
