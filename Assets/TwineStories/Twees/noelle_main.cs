...
public class noelle_main: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_4()
	{
		...
		yield return new TwineLink(@"%convo_points, 1, 2%Let's talk about you.", @"%convo_points, 1, 2%Let's talk about you.", @"you", null, null);
		yield return new TwineLink(@"%noelle_gift, 3, 3%I have a gift for you.", @"%noelle_gift, 3, 3%I have a gift for you.", @"GIFT", null, null);
	...
	void passageInit_12()
	{
		this.Passages["women"] = new TwinePassage("women", new string[]{  }, passageExecute_12);
	}
	...
	void passageInit_22()
	{
		this.Passages["you"] = new TwinePassage("you", new string[]{  }, passageExecute_22);
	}
