...
public class tutorial_end: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: Light conversation is all well and good, but should you talk to your suitors about something more personal, you may lose track of time. <b>Two deeper conversations</b>, and poof! You'll find that it's <b>dinnertime</b> already.");
		yield return new TwineText(@"");
		yield return new TwineText(@"%1, <beau>, <center>, <smile>%");
