...
public class tutorial_a: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: Just stop hiding in your room and come meet me down in the <color=""white"">sitting parlor</color>. I'll help you get ready.");	
	}
