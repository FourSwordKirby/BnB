...
public class tutorial_b: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"BEAUREGARD: Well, not with that attitude. You'll have to be <color=""yellow"">significantly more well-mannered</color> if you want to win their affections. Come, practice on me.");
		yield return new TwineText(@"");
	...
	IEnumerable<TwineOutput> passageExecute_5()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: I'm quite sure you're ready to <color=""yellow"">face your suitors</color>. ");
		yield return new TwineText(@"");
	...
	IEnumerable<TwineOutput> passageExecute_6()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: <color=""yellow"">I'll bring them in now.</color>");	
	}
	...
	IEnumerable<TwineOutput> passageExecute_7()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: <color=""yellow"">I'll bring the ladies in. </color>Please at least <i>attempt</i> to be civil?");	
	}
