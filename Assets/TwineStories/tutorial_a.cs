...
public class tutorial_a: TwineStory
{
	...
	void passageInit_1()
	{
		this.Passages["Start"] = new TwinePassage("Start", new string[]{ "1,", "<beau>,", "<center>,", "<frown>", }, passageExecute_1);
	}
	...
	IEnumerable<TwineOutput> passageExecute_1()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"BEAUREGARD: Just stop hiding in your room and come meet me in the sitting parlor. I'll help you get ready.");	
	}
