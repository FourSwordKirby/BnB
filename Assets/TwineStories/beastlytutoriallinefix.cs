/*
Generated by UnityTwine on 3/31/2016 6:46:06 PM
...
public class beastlytutoriallinefix: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_3()
	{
		...
		yield return new TwineText(@"BEAUREGARD: //A pleasure to meet you, your majesty! ");
		yield return new TwineText(@"");
		yield return new TwineText(@"[1, <beau>, <center>, <blush>]");
